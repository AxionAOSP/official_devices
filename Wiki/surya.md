# Installation Guide — POCO X3 / POCO X3 NFC (surya)
...
> - Flash **only** files meant for **POCO X3 / POCO X3 NFC (surya)**.
...
1. Download the latest **axion-*-surya.zip** from the [website](https://cdn.axionos.org/#surya).
